...
<div class="card text-center" >
    ...
    <asp:Image ID="imgNoticia" CssClass="card-img-top imagenNoticia"   runat="server" />
  ...
  <div class="card-body">
    <h3 class="card-title"><asp:Label ID="lblTitulo" runat="server" Text="Titulo Noticia"></asp:Label></h3>
      ...
      <p class="card-text text-bg-dark">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
